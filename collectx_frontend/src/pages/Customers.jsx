...
export default function Customers() {
  ...
  // Only ADMIN and SUPERVISOR can create or edit customers
  ...
  const handleCreate = async e => {
    ...
    try {
      await client.post('/customer/create', {
        // customerId omitted — auto-generated by the backend
  ...
  const handleEdit = async e => {
    ...
    try {
      await client.put(`/customer/${selected.customerId}`, {
        ...
        status: editForm.status,   // status is now handled by backend update()
      })
